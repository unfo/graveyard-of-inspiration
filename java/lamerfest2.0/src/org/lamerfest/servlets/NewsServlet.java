...
/**
   ...
   they can be displayed on the intranet.
 */

public class NewsServlet extends XSLEnabledServlet {
	...
	addEnd(xml);
	transform(new StringReader(sw.getBuffer().toString()), "index.xsl", resp);
